...
float retention_imu[RETENTION_ARRAY_SIZE];
...
float alpha_x_l, alpha_y_l, alpha_z_l;
float yaw_angle;
...
float average_pot = 0;
float average_sens1, average_sens2, average_sens3, average_sens4;
...
extern float retention_imu[RETENTION_ARRAY_SIZE];
...
extern float lowpassed_array[RETENTION_ARRAY_SIZE];
...
extern float alpha_x_l, alpha_y_l, alpha_z_l;
