...
//* 備考 : なし
//************************************************************************/
FRESULT sd_write_array_short(char *p_folder_name, char *p_file_name, short size, short *data, char state){
	FRESULT ret = 0;
...
//* 備考 : なし
//************************************************************************/
FRESULT sd_read_array_short(char *p_folder_name, char *p_file_name, short size, short *data){
	FRESULT ret = 0;
	short i = 0;
